...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UNPCInventoryComponent_HandleEmotionStateChanged_Statics::NewProp_NewState = { "NewState", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NPCInventoryComponent_eventHandleEmotionStateChanged_Parms, NewState), Z_Construct_UScriptStruct_FEmotionState, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NewState_MetaData), NewProp_NewState_MetaData) }; // 1004811449
...
{
	P_GET_STRUCT_REF(FEmotionState,Z_Param_Out_NewState);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->HandleEmotionStateChanged(Z_Param_Out_NewState);
	P_NATIVE_END;
}
...
// ********** End Class UNPCInventoryComponent constinit property declarations *********************
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UNPCInventoryComponent_HandleEmotionStateChanged, "HandleEmotionStateChanged" }, // 3862183042
...
struct Z_CompiledInDeferFile_FID_Users_alexx_OneDrive_Documents_GitHub_LLM_NPC_Source_LLM_NPC_Inventory_NPCInventoryComponent_h__Script_LLM_NPC_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNPCInventoryComponent, UNPCInventoryComponent::StaticClass, TEXT("UNPCInventoryComponent"), &Z_Registration_Info_UClass_UNPCInventoryComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNPCInventoryComponent), 3908209091U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_alexx_OneDrive_Documents_GitHub_LLM_NPC_Source_LLM_NPC_Inventory_NPCInventoryComponent_h__Script_LLM_NPC_3495984626{
	TEXT("/Script/LLM_NPC"),
